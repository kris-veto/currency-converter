...
function getImg1() {
    ...
    document.getElementById('imgContenedor1').innerHTML = `<img src="${flagUrl}" alt="Flag of ${valorFromCurrency}" width="50" style="border: 1px solid rgb(191, 191, 191)">`;
}
...
function getImg2() {
    ...
    document.getElementById('imgContenedor2').innerHTML = `<img src="${flagUrl}" alt="Flag of ${valorToCurrency}" width="50" style="border: 1px solid rgb(191, 191, 191)">`;
}
